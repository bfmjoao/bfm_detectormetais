...
-- Permissão que receberá notificações do detector e também não será verificada ao passar por um
    -- Exemplo: Policiais;
Config.notifypermissao = 'policia.permissao'
...
Config.msgperm = 'Um cidadão acaba de passar armado no detector!'
